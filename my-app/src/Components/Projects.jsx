        ...
        <div className="container container-fluid">
            ...
            <div className="d-flex justify-content-center">
                <div className="d-flex justify-content-center align-items-center bg-opacity-50 bg-info rounded-5 w-25 mt-md-3">
                    <a href={"www.linkedin.com/in/eduard-nicolás-sarmiento-herrera"}><img className="d-block mx-auto p-md-3" src={images.iconLinkedin} alt="" /></a>
                    <a href="https://github.com/edunickdev"><img className="d-block mx-auto p-md-3" src={images.iconGithub} alt=""/></a>
                </div>
            </div>
        </div>
    </div>
